  ...
  async findPipelineJobRuns(pipelineRunId: string): Promise<SparkJobRunEntity[]> {
    try {
      const jobQuery = this.dataSource.manager
        ...
        .addSelect('total_bytes_read', 'total_bytes_read')
        .addSelect('total_bytes_written', 'total_bytes_written')
        .addSelect('total_shuffle_bytes_read', 'total_shuffle_bytes_read')
        .addSelect('total_shuffle_bytes_written', 'total_shuffle_bytes_written')
  ...
  async findJob(jobId: string): Promise<SparkJobRunEntity> {
    try {
      const jobQuery = this.dataSource.manager
        ...
        .addSelect('AVG(total_shuffle_bytes_read)::INTEGER', 'total_shuffle_bytes_read')
        .addSelect('AVG(total_shuffle_bytes_written)::INTEGER', 'total_shuffle_bytes_written')
